...
> Documento vivo da integração com a **API Oficial do WhatsApp Business (Meta Cloud API)** no NASA. Última revisão: 2026-06-16 (Fase 8.1 implementada — switch de provider faz auto-provisão Uazapi/tear-down remoto, fechando o bug em que escolher Meta na criação travava o caminho de voltar pra Uazapi).
>
