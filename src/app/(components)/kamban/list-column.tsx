...
export function ListColumn() {
    ...
    return (
        <div className="flex h-full max-h-[calc(100vh-4rem)] flex-row">
            <DndContext
                sensors={sensors}
            ...
            >
                ...
                <div
                    ...
                    className="ml-4 px-4 py-6 bg-gray-950 rounded-lg h-20 cursor-pointer hover:bg-gray-900 transition-colors"
                >
                    Adicionar Coluna +
                </div>
