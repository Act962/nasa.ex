...
export function SubscriptionPlansModal({
  ...
  return (
    <Dialog open={open} onOpenChange={(o) => !o && onClose()}>
      <DialogContent className="sm:max-w-3xl bg-background border-border/40 text-foreground overflow-y-hidden p-0 shadow-2xl max-h-full">
        <div className="relative p-6 sm:p-8">
          ...
          <DialogHeader className="relative z-10 mb-8">
            <div className="flex items-center gap-3 mb-2">
              <div className="size-10 rounded-xl bg-linear-to-br from-primary to-accent sm:flex items-center justify-center shadow-lg shadow-primary/20 text-primary-foreground hidden ">
          ...
          <div className="h-full max-h-[calc(100vh-13rem)] overflow-y-auto scroll-cols-tracking">
            {plansLoading ? (
