...
export const NOTIFICATION_TEMPLATES: NotificationTemplate[] = [
  // Sistema
  {
    ...
    body: "O ÓRBITA passará por manutenção programada em {{date}} das {{startTime}} às {{endTime}}. Esperamos aproximadamente {{duration}} de indisponibilidade.",
    type: "warning",
    category: "system",
  ...
  },
  {
    ...
    body: "Uma nova versão do ÓRBITA foi lançada com {{featureCount}} melhorias e {{bugCount}} correções. Atualize para aproveitar os novos recursos!",
    type: "info",
    category: "system",
