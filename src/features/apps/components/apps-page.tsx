...
const APPS: AppDef[] = [
  {
    ...
    fullDesc: "Automatize respostas nos comentários do Instagram e leve o cliente direto para o atendimento certo. Simples, rápido e sem complicação. Mais barato, mais inteligente e integrado ao resto da operação.",
  ...
  },
  {
    ...
    fullDesc: "Controle financeiro, loja online, sistema de frente de caixa e dados do negócio no mesmo lugar. Tudo integrado ao comercial e ao atendimento.",
    category: "Gestão",
    integration: "ERP",
    action: "external",
  ...
  },
  {
    ...
    fullDesc: "Sistema de formulários inteligentes. Cada resposta do cliente vira informação estratégica. O sistema entende o interesse e organiza automaticamente no CRM.",
    category: "CRM",
    integration: "—",
    action: "modal",
    theme: "purple",
  },
  {
    ...
    fullDesc: "O WhatsApp organizado do jeito que deveria ser. Sistema de conversas interno offline. Atenda sem perder histórico, contexto ou oportunidade. Totalmente integrado ao CRM e ao Astro IA.",
  ...
  },
  {
    ...
    fullDesc: "Quem controla o tempo, controla a venda. Múltiplas agendas conectadas ao atendimento, CRM e equipe. Nada de cliente esquecido ou horário perdido.",
    category: "Agenda",
    integration: "—",
    action: "internal",
    href: "/agendas",
  ...
  },
  {
    ...
    fullDesc: "Crie propostas profissionais, envie contratos digitais e feche negócios mais rápido. Tudo integrado ao CRM.",
    category: "Vendas",
  ...
  },
  {
    ...
    fullDesc: "Links personalizados que direcionam, organizam e viram dados. Cada clique vira dado. Cada acesso vira oportunidade.",
    category: "Marketing",
    integration: "—",
    action: "modal",
    theme: "purple",
  },
  {
    ...
    fullDesc: "Acompanhe resultados, crie ranking e motive o time. Venda vira jogo. O jogo com regra gera resultado.",
    category: "Vendas",
    integration: "—",
    action: "modal",
    theme: "dark",
  },
  {
    ...
    fullDesc: "Cliente lembrado, cliente que volta. Crie programas de pontos direto no atendimento. O cliente acompanha tudo em um painel próprio.",
  ...
  },
  {
    ...
    fullDesc: "O painel de controle da sua operação. Organize tarefas, equipe, clientes e treinamentos em um único lugar. Kanban, listas, automações e mensagens integradas.",
    category: "Gestão",
    integration: "—",
    action: "modal",
    theme: "purple",
  },
  {
    ...
    fullDesc: "IA treinada para informar, preparar, quebrar objeções e sair de cena. Sem invadir a venda do humano. Sem parecer robô.",
  ...
  },
  {
    ...
    fullDesc: "Centralize pedidos, tarefas e chamados com rastreamento. Cliente acompanha. Equipe executa.",
  ...
  },
  {
    ...
    fullDesc: "Centralize todos os arquivos, documentos, imagens e links da sua organização em um único lugar. Organize por pastas, busque rapidamente e monitore o uso de armazenamento por plano.",
    category: "Documentos",
    integration: "S3",
    action: "internal",
    href: "/nbox",
  ...
  },
  {
    ...
    fullDesc: "Organize atendimentos, vendas, projetos e setores em múltiplos CRMs conectados. Rastreie de onde o cliente veio, o que quer e quando agir.",
    category: "CRM",
...
function AppCard({ app, onAction }: { app: AppDef; onAction: (app: AppDef) => void }) {
  const Icon = app.icon;
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 left-0 right-0 h-0.5 bg-gradient-to-r from-[#7C3AED] to-[#a855f7] opacity-0 group-hover:opacity-100 transition-opacity" />
      ...
      <div className="flex items-start gap-3 p-5 pb-3">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-start justify-between gap-2">
            <div>
              <h3 className="font-black text-sm tracking-wide leading-tight">{app.name}</h3>
      ...
      <div className="px-5 pb-4 flex-1">
        <p className="text-xs text-muted-foreground leading-relaxed line-clamp-2">{app.shortDesc}</p>
      </div>
      ...
      <div className="px-5 pb-5">
        {app.status === "installed" ? (
          <Button
            ...
            onClick={(e) => { e.stopPropagation(); onAction(app); }}
          >
...
export function AppsPage() {
  ...
  return (
    <div className="min-h-full bg-background">
      {/* Hero Header */}
      <div className="relative overflow-hidden border-b bg-gradient-to-br from-[#7C3AED]/5 via-background to-background">
        ...
        <div className="relative px-6 py-10 max-w-5xl mx-auto">
          ...
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-xs text-muted-foreground font-medium tracking-widest uppercase">Ecossistema NASA</span>
          </div>
      ...
      <div className="px-6 py-4 max-w-5xl mx-auto">
        <div className="flex flex-wrap gap-2">
          {FILTERS.map((f) => {
            const count = f.value === "all" ? APPS.length
              : f.value === "installed" ? installedCount
              : f.value === "development" ? devCount
              : 0;
            return (
              <button
                key={f.value}
      ...
      <div className="px-6 pb-10 max-w-5xl mx-auto">
        {filteredApps.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-20 text-center gap-3">
            ...
            <p className="text-muted-foreground text-sm">Nenhum app encontrado nesta categoria.</p>
          </div>
        ) : (
