...
5. **Modelo: OpenAI**, default `gpt-4.1`, override via `ASTRO_DEFAULT_MODEL`. Reusa `OPENAI_API_KEY` (mesma do RAG/Astro). Histórico: começou em `gpt-4o-mini` (2026-05-18); trocado pra `gpt-4.1` em 2026-05-23 após relato de respostas ruins no atendimento.
