// Registro único das funções Inngest (client + array), compartilhado entre o
// serve do Next (apps/web) e o serve do Fastify (apps/api). Fonte de verdade
// das funções registradas — não duplicar a lista nos handlers.
...
void bookingNotification;
void processUserAction;
void detectAbsence;
void detectChatTimeout;
void checkStreaks;
void checkMilestones;
void onProposalPaid;
void onOnboardingFormsCompleted;
