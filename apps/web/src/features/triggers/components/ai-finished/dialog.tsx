...
export type AiFinishedTriggerFormValues = z.infer<typeof formSchema>;

interface Props {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  onSubmit: (values: AiFinishedTriggerFormValues) => void;
  defaultValues?: Partial<AiFinishedTriggerFormValues>;
}

export const AiFinishedTriggerDialog = ({
  open,
  onOpenChange,
  onSubmit,
  defaultValues,
  ...
  const form = useForm<AiFinishedTriggerFormValues>({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          <DialogTitle>IA Finalizada</DialogTitle>
          <DialogDescription>
            Este gatilho será acionado quando uma IA finalizar um atendimento.
          </DialogDescription>
        </DialogHeader>
